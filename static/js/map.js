...
const fetcher = (url) => {
  fetch(url)
    ...
    .then(function(betaData) {
      data = betaData;
      fetch("https://docs.google.com/spreadsheets/d/e/2PACX-1vTyKk9rJG3WLoO2ky94WI3v2P9bzFiCSq1cHyAW4imT4rtNn1n8lIv8VKybV88TxFIV6_19-WW0b7De/pub?gid=2011843578&single=true&output=csv")
